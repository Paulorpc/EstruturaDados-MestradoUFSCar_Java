...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	// Implementadação solicitada pelo exercicio
	// Metodos que podem ser usados de acordo com exercício: isEmpty, first,
	...
	// Implementadação solicitada pelo exercicio
	// Metodos que podem ser usados de acordo com exercício: isEmpty, first,last, before, after,addAfter, addFirst
	public Position<E> addBefore(Position<E> pos, E e) {

		if (isEmpty() || pos.equals(first()) )
			addFirst(e);
		else {
			Position<E> before = before(pos);
